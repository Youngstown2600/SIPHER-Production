...
#include <cstddef>
#include <string>
namespace sipher {class Logger;class MultiCallManager;class SipEngine;}
...
class MainWindow final:public QMainWindow {
    Q_OBJECT
public:
    MainWindow(sipher::SipEngine& engine,sipher::MultiCallManager& multi,sipher::Logger& logger,std::string profilePath,QWidget* parent=nullptr);
private slots:
...
private:
    ...
    sipher::SipEngine& engine_;sipher::MultiCallManager& multi_;sipher::Logger& logger_;
    ...
    QString destinationFile_,callerIdFile_,queueAudioFile_,lastPcapPath_;std::string lastAuditReport_;std::string profilePath_;std::string accountsDir_;int pendingSelectId_{-1};int displayedTraceCallId_{-1};int lastPcapCallId_{-1};LastPcapKind lastPcapKind_{LastPcapKind::None};std::size_t displayedTraceCount_{0};int didLookupSerial_{0};
};
